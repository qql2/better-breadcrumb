...
import { IDataview } from 'src/external/dataview/interfaces';
import { ExplicitEdgeSource } from 'src/const/graph';
import { BreadcrumbsSettings } from 'src/interfaces/settings';
...
declare class BCGraph extends MultiGraph<BCNodeAttributes, BCEdgeAttributes> {
    constructor(
    ...
    safe_add_node(id: string, attr: BCNodeAttributes): boolean;
    /** Upsert a node by it's id (path). If it exists, patch attr, else addNode */
    upsert_node(id: string, attr: BCNodeAttributes): void;
    safe_rename_node(old_id: string, new_id: string): any;
    /** Uniquely identify an edge based on its:
     * - source_id
     * - target_id
     * - field
     */
    make_edge_id: (source_id: string, target_id: string, attr: BCEdgeAttributes) => string;
    /** Return true if the edge was added.
     * Won't be added if it already exists (based on it's {@link this.make_edge_id}),
     * 	or if it's target_node has ingore_in_edges */
    safe_add_directed_edge: (source_id: string, target_id: string, attr: BCEdgeAttributes) => boolean;
...
declare class BCAPI$1 {
    ...
    getSubForFields: (fields: string[], g?: BCGraph) => void;
    build_tree: any;
    breadth_first_traversal: any;
    create_list_index: (start_node?: any, options?: ListIndex.Options) => any;
    /** @deprecated Use flatten_all_paths and flat_paths_to_index_list instead. Or, create_list_index */
    createIndex: () => void;
    get_neighbours: (source?: any) => BCEdge[];
    /** @deprecated Use get_neighbours instead */
    getMatrixNeighbours: (source?: any) => BCEdge[];
}

declare class BreadcrumbsPlugin extends Plugin {
    ...
    activateView(view_id: string, options?: {
        side?: "left" | "right";
    }): Promise<void>;
}
...
declare class MyPlugin extends Plugin {
